...
# 1. โหลดข้อมูลจากโฟลเดอร์ data/processed/
...
# เซฟลง weights/
joblib.dump(xgb_full, '../weights/xgboost_bodyfat_with_waist.pkl')
...
# เซฟลง weights/
joblib.dump(xgb_basic, '../weights/xgboost_bodyfat_no_waist.pkl')

print("\n✅ เซฟไฟล์ XGBoost (.pkl) ทั้ง 2 ตัวลงใน weights/ เรียบร้อย!")